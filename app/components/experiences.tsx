    ...
    <section id="experiences" className="experiences h-screen w-screen">
      ...
      >
        {experiences.map((exp) => (
          ...
          >
            <article id={exp.id} className="p-6">
              <h3 className="text-xl font-semibold mb-4">{exp.title}</h3>
              <h4 className="text-lg font-semibold mb-4">{exp.entreprise}</h4>
              <p className="text-sm font-semibold mb-4">{exp.lieu}</p>
              <p className="text-sm font-semibold mb-4">{exp.date}</p>
              <p>{exp.description}</p>
              <Image src={exp.image} alt="s" width={50} height={50} />
            </article>
          </SwiperSlide>
        ))}
      </Swiper>
